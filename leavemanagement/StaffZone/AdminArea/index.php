                            ...
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header justify-content-center">
                                    ...
                                    <h3 class="font-weight-light my-4 text-center">
                                        ...
                                        <br /> <br />
                                        <b>Administrative Department(Vani Mandir)</b>
                                    </h3>
                                </div>
                                <div class="card-body">

                                    <form action="code/AdminLogin.php" method="post">
                                        <div class="form-group"><label class="small mb-1" for="inputEmailAddress">Email</label><input class="form-control py-4"  type="email" name="email" placeholder="Enter Email Address"></div>
