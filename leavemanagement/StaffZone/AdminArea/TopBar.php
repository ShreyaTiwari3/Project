<nav class="sb-topnav navbar navbar-expand shadow navbar-light bg-white" id="sidenavAccordion">
    <a class="navbar-brand" href="Dashboard"><img src="<?= $logo ?>" style="height:50px; width:55px;"></a><button class="btn sb-btn-icon sb-btn-transparent-dark order-1 order-lg-0 mr-lg-2" id="sidebarToggle" href="#"><i data-feather="menu"></i></button>
            ...
            <div class="dropdown-menu dropdown-menu-right border-0 shadow animated--fade-in-up" aria-labelledby="navbarDropdownUserImage">
                ...
                <h6 class="dropdown-header d-flex align-items-center">
                    ...
                    <div class="sb-dropdown-user-details">
                        <div class="sb-dropdown-user-details-name"><?php echo $row_admin["name"]; ?></div>
                        <div class="sb-dropdown-user-details-email"><?php echo $row_admin["email"]; ?></div>
                    </div>
                </h6>
